...
export function QueryAuthHandler({ requiredOrg, children }: QueryAuthHandlerProps) {
  ...
  useEffect(() => {
    const processAuth = async () => {
      ...
      if (authToken && !isProcessing) {
        ...
        try {
          ...
          if (requiredOrg && validation.orgName?.toLowerCase() !== requiredOrg.toLowerCase()) {
    ...
    processAuth();
  }, [searchParams, requiredOrg, isProcessing]);
